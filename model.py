...
# Load data
df_train = pd.read_csv("C:/Users/91898/Desktop/Disease-Prediction-System-main/Training.csv")
df_test = pd.read_csv("C:/Users/91898/Desktop/Disease-Prediction-System-main/Testing.csv")
...
def main():
    ...
    if st.sidebar.button("Predict Disease"):
        ...
        st.text_area("Result", result, height=1)
    else:
        # Initialize the text_area with an empty string if the button is not clicked
        st.text_area("Result", "", height=1)
